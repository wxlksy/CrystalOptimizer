package psychodreams.optimizer;
...
public class Optimizer implements ClientModInitializer
{
    ...
    public void onInitializeClient()
    {
        ...
        EnableCommand command = new EnableCommand();
    ...
    public static BlockHitResult generalLookPos()
    {
